            ...
            if self.local_module_num == 1:
                ...
                for i in range(len(self.Encoder_Net) - 1):
                    if i == 0:
                        ...
                        loss_x1 = eval('self.net_decoder_' + str(local_index) + '_' + str(layer_index))(x, self._image_restore(img))
                        loss_x2 = eval('self.net_classifier_' + str(local_index) + '_' + str(layer_index))(x, target)
                        loss_y1 = eval('self.aux_decoder_' + str(local_x) + '_' + str(layer_x))(z, self._image_restore(
                            img))
